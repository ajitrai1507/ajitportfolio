          ...
          <div className={styles.grid}>
            <div className={`${styles.infoCard} glass-card`}>
              ...
              <div className={styles.contactItem}>
                ...
                <div className={styles.details}>
                  ...
                  <a href="https://wa.me/917503172305" target="_blank" rel="noopener noreferrer">Chat on WhatsApp</a>
                </div>
              </div>
            </div>
            ...
            <div className={`${styles.socialCard} glass-card`}>
              ...
              <div className={styles.socialLinks}>
                ...
                <a href="https://x.com/AjitRai38853877" target="_blank" rel="noopener noreferrer" className={styles.socialLink}>Twitter (X)</a>
              </div>
            </div>
          </div>
